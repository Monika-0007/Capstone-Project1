...
if st.button("Predict"):
    ...
    # st.write("Expected features (model):", len(feature_names))
    # st.write("Input features:", X_prepared.shape[1])
    # st.write("Model features:", list(feature_names))
    # st.write("Prepared input columns:", list(X_prepared.columns))
